...
#include "PUBGAbilityTagRelationshipMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FPUBGAbilityTagRelationship
{
	GENERATED_BODY()

public:
	FPUBGAbilityTagRelationship() : AbilityTag(FGameplayTag::EmptyTag) {}
...
UCLASS()
class UPUBGAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FPUBGAbilityTagRelationship> AbilityTagRelationships;
