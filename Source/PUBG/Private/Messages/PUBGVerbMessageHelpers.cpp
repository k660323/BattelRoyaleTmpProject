...
FString FPUBGVerbMessage::ToString() const
{
	FString HumanReadableMessage;
	FPUBGVerbMessage::StaticStruct()->ExportText(/*out*/ HumanReadableMessage, this, /*Defaults=*/ nullptr, /*OwnerObject=*/ nullptr, PPF_None, /*ExportRootScope=*/ nullptr);
...
APlayerState* UPUBGVerbMessageHelpers::GetPlayerStateFromObject(UObject* Object)
{
...
APlayerController* UPUBGVerbMessageHelpers::GetPlayerControllerFromObject(UObject* Object)
{
	if (APlayerController* PC = Cast<APlayerController>(Object))
	{
		return PC;
...
FGameplayCueParameters UPUBGVerbMessageHelpers::VerbMessageToCueParameters(const FPUBGVerbMessage& Message)
{
...
FPUBGVerbMessage UPUBGVerbMessageHelpers::CueParametersToVerbMessage(const FGameplayCueParameters& Params)
{
	FPUBGVerbMessage Result;
